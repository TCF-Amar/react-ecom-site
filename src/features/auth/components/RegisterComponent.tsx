...
import { FiEye, FiEyeOff, FiLock, FiMail, FiShoppingBag, FiUser } from "react-icons/fi";
...
function RegisterComponent({ setParams , showPassword , togglePass}: RegisterProps) {
  ...
  return (
    <div className="flex-1 flex flex-col justify-center p-8 w-full max-w-full lg:max-w-150 lg:px-16">
      <div className="w-full max-w-104 mx-auto opacity-100 transition-opacity duration-500">
        ...
        <div className="mb-10">
          ...
          <p className="text-slate-500 text-base">
            Join LuxeCart and start shopping today.
          </p>
        </div>
          ...
          <div className="mb-5">
            ...
            <div className="relative flex items-center">
              <input
                ...
                required
              />
              <FiUser className="absolute left-4 text-slate-400 text-[1.125rem] pointer-events-none transition-colors" />
            </div>
          </div>
          <div className="mb-5">
            <label
          ...
          <div className="mb-5">
            ...
            <div className="relative flex items-center">
              <input
                ...
                required
              />
              <FiLock className="absolute left-4 text-slate-400 text-[1.125rem] pointer-events-none transition-colors" />
               <button
                              type="button"
        ...
        <div className="text-center mt-10 text-[0.9375rem] text-slate-500 flex gap-2 justify-center">
          ...
          <p
            onClick={() => setParams({ mode: "sign-in" })}
